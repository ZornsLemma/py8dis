...
with moved(move(0x8000, 0x2000, 0x4000)):
    acorn.bbc()
    ...
    for i in range(7):
        ...
        # separately.)
        code_at = utils.get_u16_be_runtime(pc) + 1 # TODO: shouldn't need to import utils??
        if code_at <= 0xffff:
    ...
    nmi3_move_id = mymove(0xd39, 0x9030, 0xe)
    ...
    nmi2_move_id = mymove(0xd00, 0x9067, 0x94)
