...
mylabel(0x80, "temp0_low")
mylabel(0x81, "temp0_high")
mylabel(0x82, "temp1_low")
mylabel(0x83, "temp1_high")
mylabel(0x82, "temp2_low")
mylabel(0x83, "temp2_high")
mylabel(0x84, "temp3")
mylabel(0x85, "temp4")
mylabel(0x86, "temp5")
mylabel(0x87, "temp6")
...
mylabel(0x008e, "page_low")
mylabel(0x008f, "page_high")

mylabel(0x4684, "unused")
mylabel(0x4693, "the_frontiers_string")
expr(0x47ee, "<the_frontiers_string")
expr(0x47f2, ">the_frontiers_string")
mylabel(0x47a2, "unused")
mylabel(0x47ce, "skip")
comment(0x2e37, "tab into position, TAB(33,30):")
comment(0x2e46, "display the characters for the score")
mylabel_with_comment(0x2dd0, "apply_delta_to_score", "add to score (in binary coded decimal)")
...
mylabel_with_comment(0x2008, "sound_0", "[only 4 bytes, but should be eight bytes]")
mylabel_with_comment(0x2210, "set_foreground_colour_to_white_string")
string(0x223d, 2)
mylabel_with_comment(0x22bd, "plot_shields_text")
mylabel_with_comment(0x22c9, "plot_blank_text")

mylabel(0x22a5, "loop")
mylabel(0x22b3, "loop")
mylabel(0x22bf, "loop")
mylabel(0x22cb, "loop")
mylabel_with_comment(0x22b1, "plot_one_two_three_four_text")
mylabel_with_comment(0x22a3, "plot_energy_text")
expr(0x4017, "<instructions_string")
expr(0x401b, ">instructions_string")
expr(0x4023, "'~'")
mylabel_with_comment(0x4494, "enter_your_name_string")
mylabel(0x4031, "finished_plotting_instructions")
expr(0x43e5, "<starfleet_records_string")
expr(0x43e9, ">starfleet_records_string")
expr(0x453c, "<enter_your_name_string")
expr(0x4540, ">enter_your_name_string")
mylabel(0x44d3, "input_buffer")
mylabel(0x44e1, "input_osword_block")
word(0x44e1, 1)
expr(0x44e1, "input_buffer")

mylabel(0x4321, "unused")
mylabel(0x44e6, "unused")

mylabel(0x2338, "loop")
mylabel(0x18e4, "plot_segment")
...
expr(0x1cca, "<starship_explosion_table")
mylabel(0x1ccb, "starship_explosion_address_high")
expr(0x1ccb, ">starship_explosion_table")
...
byte(0x1cf7, 16, 1)
expr(0x1cf7, "<(enemy_explosion_tables + $0000)")
expr(0x1cf8, "<(enemy_explosion_tables + $0040)")
expr(0x1cf9, "<(enemy_explosion_tables + $0080)")
expr(0x1cfa, "<(enemy_explosion_tables + $00c0)")
expr(0x1cfb, "<(enemy_explosion_tables + $0100)")
expr(0x1cfc, "<(enemy_explosion_tables + $0140)")
expr(0x1cfd, "<(enemy_explosion_tables + $0180)")
expr(0x1cfe, "<(enemy_explosion_tables + $01c0)")
expr(0x1cff, "<(enemy_explosion_tables + $0200)")
expr(0x1d00, "<(enemy_explosion_tables + $0240)")
expr(0x1d01, "<(enemy_explosion_tables + $0280)")
expr(0x1d02, "<(enemy_explosion_tables + $02c0)")
expr(0x1d03, "<(enemy_explosion_tables + $0300)")
expr(0x1d04, "<(enemy_explosion_tables + $0340)")
expr(0x1d05, "<(enemy_explosion_tables + $0380)")
expr(0x1d06, "<(enemy_explosion_tables + $03c0)")
mylabel(0x1d08, "enemy_explosion_address_high_table")
expr(0x1d08, ">(enemy_explosion_tables + $0000)")
expr(0x1d09, ">(enemy_explosion_tables + $0040)")
expr(0x1d0a, ">(enemy_explosion_tables + $0080)")
expr(0x1d0b, ">(enemy_explosion_tables + $00c0)")
expr(0x1d0c, ">(enemy_explosion_tables + $0100)")
expr(0x1d0d, ">(enemy_explosion_tables + $0140)")
expr(0x1d0e, ">(enemy_explosion_tables + $0180)")
expr(0x1d0f, ">(enemy_explosion_tables + $01c0)")
expr(0x1d10, ">(enemy_explosion_tables + $0200)")
expr(0x1d11, ">(enemy_explosion_tables + $0240)")
expr(0x1d12, ">(enemy_explosion_tables + $0280)")
expr(0x1d13, ">(enemy_explosion_tables + $02c0)")
expr(0x1d14, ">(enemy_explosion_tables + $0300)")
expr(0x1d15, ">(enemy_explosion_tables + $0340)")
expr(0x1d16, ">(enemy_explosion_tables + $0380)")
expr(0x1d17, ">(enemy_explosion_tables + $03c0)")
...
mylabel(0x2216, "set_foreground_colour_to_black_string")
...
mylabel_with_comment(0x2336, "disable_cursor")
...
mylabel(0x23fe, "unused_not_copy")
mylabel(0x2406, "unused_not_shift_one")
mylabel(0x240e, "unused_not_shift_two")
mylabel(0x2416, "unused_not_shift_three")
...
entry(0x2c19, "unused_routine_to_turn_enemy_ship_on_screen_towards_starship")
...
picture_sprite(0x2c60, "starship_sprite_1",1,32)
picture_sprite(0x2c80, "starship_sprite_2",1,32)
picture_sprite(0x2ca0, "starship_sprite_3",1,32)
picture_sprite(0x2cc0, "starship_sprite_4",1,32)
picture_sprite(0x2ce0, "starship_sprite_5",1,32)
picture_sprite(0x2d00, "starship_sprite_6",1,32)
picture_sprite(0x2d20, "starship_sprite_7",1,32)
picture_sprite(0x2d40, "starship_sprite_8",1,32)
...
expr_label(0x2d66, "score_as_bcd + 1")
expr_label(0x2d67, "score_as_bcd + 2")
mylabel(0x2d68, "unused")
mylabel(0x2d6e, "score_as_digits")
expr_label(0x2d6f, "score_as_digits + 1")
expr_label(0x2d70, "score_as_digits + 2")
expr_label(0x2d71, "score_as_digits + 3")
expr_label(0x2d72, "score_as_digits + 4")
expr_label(0x2d73, "score_as_digits + 5")
...
expr_label(0x3908, "previous_score_as_bcd + 1")
expr_label(0x3909, "previous_score_as_bcd + 2")
...
mylabel_with_comment(0x4335, "high_score_table", "There are eight entries of 16 bytes each. The first three bytes are the score, then 13 bytes for the name")
expr_label(0x4336, "high_score_table + 1")
expr_label(0x4337, "high_score_table + 2")
expr_label(0x4338, "high_score_table + 3")
expr_label(0x4345, "high_score_table + 16")
...
mylabel_with_comment(0x44e8, "check_for_high_score")
mylabel(0x4503, "consider_records_loop")
mylabel(0x451f, "consider_next_record")
mylabel(0x4528, "score_is_zero")
